    ...
    return(
        <section id="work" className="steps-section gridrowfull">
            ...
            <div className="steps-container">
                <div className="steps step01 col-12 col-d-4 col-t-12">
                ...
                <div className="steps step02 col-12 col-d-4 col-t-12">
                    <div className="titleStep">
                ...
                <div className="steps step03 col-12 col-d-4 col-t-12">
                    <div className="titleStep">
                ...
                <div className="steps step04 col-12 col-d-4 col-t-12">
                    <div className="titleStep">
                ...
                <div className="steps step05 col-12 col-d-4 col-t-12">
                    <div className="titleStep">
